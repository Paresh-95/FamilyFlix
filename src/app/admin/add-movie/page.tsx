...
export default function AddMoviePage() {
  ...
  function pick(movie: TmdbResult) { setSelected(movie); setQuery(movie.title); setResults([]); }
    ...
    <div className="min-h-screen bg-netflix-dark">
      ...
      <div className="relative pt-24 pb-10 px-6 md:px-12 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-netflix-red text-xs font-bold uppercase tracking-widest mb-2">Add Content</p>
          <h1 className="text-white text-4xl md:text-5xl font-black tracking-tight">Add Movie</h1>
          <p className="text-white/30 mt-2 text-base">Search TMDB and link a Google Drive file</p>
        </div>
      </div>
